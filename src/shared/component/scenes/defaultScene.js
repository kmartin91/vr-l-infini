...
const DefaultScene = ({
  ...
  return (
    <a-scene
      stats={stats}
      inspector={debug ? 'url: https://aframe.io/releases/0.3.0/aframe-inspector.min.js' : ''}
    >
      <a-assets>
      ...
      {modelLinkType === 'fbx' && <React.Fragment>{/* Todo */}</React.Fragment>}
